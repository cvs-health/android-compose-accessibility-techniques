...
import com.cvshealth.accessibility.apps.composeaccessibilitytechniques.ui.scrolling_columns.scrollingInteractiveColumnExample1HeadingTestTag
import com.cvshealth.accessibility.apps.composeaccessibilitytechniques.ui.scrolling_columns.scrollingInteractiveColumnScreenHeadingTestTag
import com.cvshealth.accessibility.apps.composeaccessibilitytechniques.ui.scrolling_columns.scrollingInteractiveColumnTestTag
...
/**
 *  ScrollingInteractiveColumnsTests - test scrolling column with interactive content screen
 *  semantics. 
 */
class ScrollingInteractiveColumnsTests {
    @get:Rule
    ...
    fun verifyHeadingsAreHeadings() {
        composeTestRule
            ...
            .assertExists()
        composeTestRule
            .onNode(hasTestTag(scrollingInteractiveColumnScreenHeadingTestTag) and isHeading())
            .assertExists()
        composeTestRule
            .onNode(hasTestTag(scrollingInteractiveColumnExample1HeadingTestTag) and isHeading())
            .assertExists()
    }
    ...
    fun verifyInitialScrollState() {
        composeTestRule.onNode(
            hasTestTag(scrollingInteractiveColumnTestTag)
                    and
    ...
    fun verifyPageDownKeyScrollsDown() {
        ...
        // Focus on Column
        composeTestRule
            .onNodeWithTag(scrollingInteractiveColumnTestTag)
            .requestFocus()
