...
// Theme colors generated using Material Theme Builder: https://m3.material.io/theme-builder.
...
val seed = Color(0xFFCC0000)

// Note: Prefer theme colors over direct color values such as these.
// Use these colors with caution: verify that they have sufficient contrast against the background
// where they are used in both Light theme and Dark themes.
val SuccessGreen = Color(0xFF118738)
